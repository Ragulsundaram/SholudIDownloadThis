  ...
  "categories": [
    {
      ...
      "detail": "Camera and microphone access are user-initiated for Stories, Reels, posts, Live, and calls. The App Store privacy label confirms access is on-demand and not continuous.",
    ...
    },
    {
      ...
      "detail": "The App Store privacy label lists both 'Precise Location' and 'Coarse Location' as collected. Precise location is optional and user-initiated for geo-tagging posts and location-based features. Coarse location is continuously inferred from IP address and used for ad targeting, content recommendations, and diagnostics. There is no opt-out for IP-based location inference.",
    ...
    },
    {
      ...
      "detail": "Contact syncing is optional but encouraged during onboarding. The uploaded contact list is stored on Meta servers and used to build social connection recommendations. The App Store label lists 'Contacts' as collected. There is no indication that this data is isolated from Meta's broader data infrastructure.",
    ...
    },
    {
      ...
      "optional_access": true,
      "background_access": false,
      "plain_english": "Instagram only accesses your photos and videos when you choose to post them, add to your story, or send in a message. It does not scan your camera roll in the background.",
      "detail": "Storage access is user-initiated for posting content to the feed, Stories, Reels, or sending via direct message. The App Store label lists 'Photos or Videos' as collected. There is no indication of background library scanning.",
    ...
    },
    {
      ...
      "background_access": false,
      "plain_english": "Instagram shares your data extensively with other Meta companies and uses it to track you across third-party apps and websites for advertising. Your contact info, identifiers, and other data are linked with data from outside Instagram.",
      "detail": "The App Store privacy label explicitly lists 'Data Used to Track You' across third-party apps and sites, including Contact Info, Identifiers, and Other Data. Data is also 'Linked to You' for Third-Party Advertising. The Play Store Data Safety notes 'Device or other IDs' are shared with other companies for 'Advertising or marketing.' Meta's privacy policy confirms intra-family data sharing for ads and product improvement. The scope includes behavioral, device, location, and account data.",
      ...
      "concerns": [
        "Cross-app tracking across third-party apps and websites",
    ...
    },
    {
      ...
      "detail": "An email address or phone number is required for registration. The App Store label lists extensive contact info collected: physical address, email, name, phone number, and other user contact info. Profile name, photo, and bio are visible to other users by default. Meta's Accounts Center allows linking Instagram to Facebook and WhatsApp, creating a unified identity profile.",
    ...
    },
    {
      ...
      "detail": "The App Store label lists 'Browsing History', 'Search History', 'Usage Data' (Product Interaction, Advertising Data, Other Usage Data), and 'Sensitive Info' as collected and linked to identity for advertising, analytics, and personalization. Instagram shows ads in the feed, Stories, Reels, and Explore. It also tracks user behavior across third-party apps and sites using Meta's advertising SDKs and pixels. This is comprehensive behavioral profiling.",
      ...
      "concerns": [
        ...
        "Ad targeting based on sensitive inferences",
    ...
    },
    {
      ...
      "detail": "IP address logging is continuous during app use. The IP is used for approximate location inference (city/country level), security monitoring, and diagnostic purposes. The App Store label lists 'Other Data' used for tracking, which includes IP-derived information. There is no opt-out for IP-based logging.",
    ...
    },
    {
      ...
      "optional_access": false,
      "background_access": false,
      "plain_english": "Instagram collects detailed information about your device including its model, operating system, unique device IDs, and app performance data. These identifiers are shared across all Meta apps to link your activity together.",
      "detail": "The App Store label lists 'Identifiers' (User ID, Device ID) and 'Diagnostics' (Crash Data, Performance Data, Other Diagnostic Data) as collected. Meta's privacy policy explicitly collects device attributes including hardware model, OS version, battery level, signal strength, carrier, and unique identifiers. These device IDs enable cross-app tracking within the Meta ecosystem.",
    ...
    },
    {
      ...
      "optional_access": true,
      "background_access": false,
      "plain_english": "The App Store privacy label says Instagram may optionally collect health and fitness data. If you use biometric unlock like Face ID, that data stays on your phone and Instagram never sees it.",
      "detail": "The App Store label lists 'Health & Fitness' data (Health, Fitness) as collected for Analytics and App Functionality. This suggests optional health-related features may collect such data. Device-level biometric authentication (Face ID, Touch ID) is handled by the operating system locally and is not accessed by Instagram.",
    ...
    },
    {
      ...
      "detail": "The App Store label lists 'Purchases' (Purchase History) and 'Financial Info' (Other Financial Info, Payment Info, Credit Info) as collected. Instagram has in-app shopping, tipping, and paid promotion features. Payment processing is handled by third-party processors for some transactions, but purchase history and financial info are collected by Instagram.",
      ...
      "concerns": [
        ...
        "Financial data scope is broad in App Store disclosures"
      ],
      "score_impact": -5
    },
    {
...
- **Your behavior powers ads across the internet.** Instagram tracks your searches, browsing history, and interactions to target ads at you on and off the app.
...
- **Deep device fingerprinting linked across Meta apps.** Device IDs and usage patterns are shared across Facebook, Instagram, and WhatsApp.
...
### Verdict
Instagram is free because you are the product. The app collects an enormous amount of behavioral, location, and identity data to power Meta's advertising business. Your direct messages are not encrypted, and there is no practical way to use the app without being tracked. If privacy matters to you, consider whether the trade-off is worth it.
