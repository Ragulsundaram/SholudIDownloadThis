# Google Pay: Save, Pay, Manage — Privacy Review

## Summary Card

- **App:** Google Pay: Save, Pay, Manage
- **Overall Risk:** Caution
- **Score:** 62 / 100
- **Grade:** C

### Red Flags
- Payment methods stored on Google servers
- Every purchase is tracked and profiled
- Transaction data shared with merchants
- Financial data linked to Google profile

### Green Flags
- Card numbers are tokenized
- Encryption and fraud protection
- You can manage and delete payment data

### Verdict
Google Pay is a digital wallet and payment system. It stores your payment methods and transaction history on Google's servers. While Google uses encryption and fraud detection, your purchase data contributes to your broader Google advertising profile, and your information is shared with merchants, payment processors, and financial institutions.
