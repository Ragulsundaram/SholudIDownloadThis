...
### Red Flags
- Precise location tracked continuously
- Location used for targeted advertising
- Location shared across Google services
- Location history stored for years

### Green Flags
- You can control location settings
- Incognito mode available
- You can export and delete location data

### Verdict
Google Maps is the world's most popular navigation app. It requires access to your precise GPS location to provide directions, but it also collects Wi-Fi networks, Bluetooth devices, and sensor data to track you. Your location history feeds into Google's advertising system, and your data is shared with third-party partners and law enforcement.
