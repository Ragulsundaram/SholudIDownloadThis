...
- **Added red flag for Google transcription:** Premium voice-to-text feature sends audio to Google
- **Updated data sharing category:** More specific details on when and why data is shared with third parties
- **Clarified contacts risk:** While contacts are uploaded, they're not shared/sold and can be deleted
- **Added green flag for open source:** Telegram's reproducible builds are a significant transparency advantage
- **Policy last updated:** September 29, 2024 (new default account self-destruction period)
