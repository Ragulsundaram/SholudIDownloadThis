...
- Activity tracked across all Google services
- Data shared with advertisers and partners
- Emails disclosed to governments when requested

### Green Flags
- No ads based on Gmail content
- Encryption in transit and at rest
- Comprehensive privacy controls
- You can delete your account and export data

### Verdict
Gmail is a powerful email service, but Google scans your emails for security and uses your activity across all Google services to build an advertising profile. While Gmail content is not used for ads, your broader activity feeds into Google's ad network.
