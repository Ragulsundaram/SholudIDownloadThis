# Discord – Talk, Play, Hang Out — Privacy Review

**Overall Risk:** Caution | **Score:** 62/100 | **Grade:** C

## Red Flags
- **Your contacts are uploaded to Discord servers:** If you enable contact syncing, Discord uploads the phone numbers in your address book to its servers to find friends who also use Discord.
- **Your behavior fuels sponsored content and ads:** Discord tracks how you use the app to show you sponsored experiences like Quests and to advertise Discord on other platforms. It also receives demographic and behavioral data about you from third-party advertisers and data providers.
- **Discord buys data about you from outside sources:** Discord receives information about you from advertisers, third-party data providers, and social media platforms. This includes demographic information and how you engage with other products outside of Discord.
- **Your messages may be scanned for policy violations:** Discord uses automated systems and may scan your attachments and messages to detect harmful content, enforce its rules, and train moderation models. Content in larger public spaces may also be used to improve Discord features.

## Green Flags
- **Discord does not sell your personal data:** Discord explicitly states that it does not make money by selling your personal information to third parties. Its business is funded through subscriptions and paid products.
- **Voice and video calls are end-to-end encrypted:** Your voice and video calls on Discord are designed to be end-to-end encrypted, meaning Discord cannot listen in on your conversations.
- **You can turn off personalization and delete your account:** Discord gives you settings to limit how your data is used for personalization and service improvement. You can also permanently delete your account and request a copy of your data.

## Verdict
Discord is better than many social apps because it does not sell your data and lets you opt out of personalization. However, it still tracks behavior for sponsored content and receives data from outside sources. If you need a private space, use end-to-end encrypted direct messages and turn off personalization in settings.
...
17.
Welcome!
This Privacy Policy explains how we collect, use, store, protect, and share your personal information through our services. If you reside in the European Economic Area (“EEA”), Discord Netherlands BV is the “data controller” of your personal information collected through the services (as defined in our
Terms of Service
...
. We are committed to enabling you to build meaningful connections around the joy of playing games through voice, video and text features. Respecting user privacy is a key part of
that mission
.
We don’t sell your personal information
.  Our business is funded through subscriptions, paid products, and sponsored content, not based on selling your personal information to third parties.
...
. Our dedicated Trust and Safety team works hard to help keep our users safe. We also use certain information to help us identify violations of our terms and policies (such as our
Community Guidelines
) in order to prevent harmful content or conduct on the services.
We give you control
...
, and
Information we receive from other sources
—for the following reasons and according to these legal bases (where applicable). For each reason, we describe how we process your information to achieve each purpose. This processing can include use of automated technologies such as machine learning systems that help us power and improve our services. In certain jurisdictions, we rely on consent (implied or express) to collect, use and disclose personal information, subject to limited exceptions. As a result, the legal bases below may not apply to you. Please see Information About Local Privacy Laws page located
here
.
...
. We use your information to personalize our services. This can include customizing your experience on Discord so that you see communities, activities, applications, features or promotions from us, or other content that may be of interest to you. As discussed in the “
How to control your privacy
” section below, you can choose to what extent we will use your personal information to personalize your Discord experience.
To deliver relevant sponsored content
. We use your information to help us surface sponsored content (like Quests and other sponsored formats) that may be of interest to you. As discussed in the “
How to control your privacy
” section below, you can choose to what extent we will use your personal information to personalize your Discord experience.
...
We may disclose information if we believe in good faith that it's necessary to prevent death or other serious harm to a person.
To enforce our policies and rights
. We may disclose information if needed to enforce our
Terms of Service
,
Community Guidelines
, any of our other policies, or to protect the rights, property, and safety of ourselves and others.
...
in our Help Center
or in the User Settings menu within Discord. The default and availability of some of these settings may be different depending on factors like your
age
or location.
...
.
In order to learn about the specific rights you may have regarding the international transfer of your personal data, please consult the relevant
standard contract clauses
or
adequacy decisions
or reach out to us at privacy@discord.com. The rights listed under 'Exercise your rights' will always apply, regardless of whether your data is transferred or not.
Services offered by third parties
