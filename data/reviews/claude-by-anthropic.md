...
**App:** Claude by Anthropic  
**Overall Risk:** Caution  
**Score:** 77 / 100  
**Grade:** B

### Red Flags
- Conversations may train AI models by default: Unless you turn it off in your account settings, the things you type into Claude can be used to train and improve Anthropic's AI models.
- Your general location is inferred from your IP address: Anthropic automatically figures out your general area from your IP address every time you use the app.
- Third-party integrations can collect your data independently: If you connect third-party apps or services to Claude, those third parties can collect data about you on their own terms.
- Conversations may be reviewed for safety: Anthropic may review your conversations to detect fraud, abuse, illegal activity, and policy violations. This means your chats are subject to automated and potentially human review.

### Green Flags
- No sale of personal data: Anthropic explicitly states that it does not sell your personal data.
- No third-party ad tracking: Claude does not show you ads from third-party advertisers or share your data with advertising networks for targeting.
- Strong deletion and export rights: You can delete individual conversations or your entire account, and you can request a copy of your data. Anthropic also provides rights to correct, restrict, and object to processing.
- You can opt out of model training: Anthropic gives you a setting to stop your conversations from being used to train its AI models.

### Verdict
Claude stands out as a more privacy-conscious AI assistant. It does not sell your data, does not show third-party ads, and gives you meaningful controls over your information. The main concern is that your conversations may be used to improve models unless you opt out. For most users, Claude is a solid choice if you adjust the training opt-out setting.
...
for information on how our large language models are ‘trained’ and how personal data obtained from third party sources, including where others may submit personal data when using our services, may be used when developing or delivering our products and services.
...
If you are located in Canada, Brazil, or the Republic of Korea, please read the relevant
Regional Supplemental Disclosure
which applies to you.
If you are located in Washington or a state with similar consumer health data laws, please read our
Consumer Health Data Privacy Policy
which applies to you if you integrate third party health applications with Claude.
...
Inputs and Outputs:
You are able to interact with our Services in a variety of formats, including but not limited to chat, coding, and agentic sessions (
“Prompts”
or
"Inputs"
), which generate responses and actions (
“Outputs”
) based on your Inputs. This includes third-party applications you choose to integrate with our Services. If you include personal data or reference external content in your Inputs, we will collect that information and this information may be reproduced in your Outputs.
...
click here
.
Anthropic gives you access to a variety of tools to help you manage your data. You can access these in your
Privacy Settings
.
5. Data Transfers
...
7. Children
Our Services are not directed towards, and we do not knowingly collect, use, disclose, sell, or share any information from children under the age of 18. If you become aware that a child under the age of 18 has provided any personal data to us while using our Services, please email us at
privacy@anthropic.com
